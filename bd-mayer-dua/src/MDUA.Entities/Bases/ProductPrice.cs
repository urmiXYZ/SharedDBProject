...
{
	[Serializable]
    [DataContract(Name = "ProductPrice", Namespace = "http://www.piistech.com//entities")]
	public partial class ProductPrice : ProductPriceBase
	{
		...
		{
			if (obj.GetType() != typeof(ProductPrice))
            {
                return false;
            }			
			
			 ProductPrice _paramObj = obj as ProductPrice;
            if (_paramObj != null)
            {			
