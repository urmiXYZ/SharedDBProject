...
namespace MDUA.DataAccess
{
	public partial class UserPermissionDataAccess : BaseDataAccess, IUserPermissionDataAccess
	{
        ...
        /// </summary>
        /// <returns>A list of UserPermission objects</returns>
		public UserPermissionList GetByPermissionId(Int32 _PermissionId)
		{
        ...
        /// </summary>
        /// <returns>A list of UserPermission objects</returns>
		public UserPermissionList GetByPermissionGroupId(Int32 _PermissionGroupId)
		{
		...
		protected void FillObject(UserPermissionBase userPermissionObject, SqlDataReader reader, int start)
		{
				...
				userPermissionObject.PermissionId = reader.GetInt32( start + 2 );			
				userPermissionObject.PermissionGroupId = reader.GetInt32( start + 3 );			
